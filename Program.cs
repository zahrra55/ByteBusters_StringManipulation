...
namespace String_Mainpulation___Mostafa_Omar
{
    internal class Program
    {
        ...
        */
        //sol 
        // راح اعرف متغيرين حتى واحد يحمل الجملة وواحد يحمل المتناظر
        // وراها اسوي لوبين واحد داخل بالثاني، اخذ الحرف الاول واقارن وية كل حرف واحسب وجودة واشوف وين موجود 
        // اذا موجود بالموقع الثاني راح 
        //

        //static string GetLongestPalindromicInString(string str1)
        //{
        //    string check = "";
        //    if (str1.Length > 0)
        //    {
...
>>>>>>> 8c2b5f67645906c5f348cb63ec70230354eae429
